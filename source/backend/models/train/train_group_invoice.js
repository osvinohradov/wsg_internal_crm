...
const TrainGroupInvoiceSchema = new Schema({
    // Номер
...
const TrainGroupInvoice = mongoose.model('TrainGroupInvoice', TrainGroupInvoiceSchema);

export default TrainGroupInvoice;