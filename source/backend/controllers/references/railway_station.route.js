...
router.route('/reference/railway_stations')
    // Отримуємо n єлементів за БД
    .get(async (req, res) => {
        // References.ServiceTypeController.get_service_types(req, res);
    });

router.route('/reference/railway_stations/names')
    // Отримати всі існуючі рахунки
    .get(async (req, res) => {
        References.RailwayStationController.get_railway_stations_names(req, res);
    });

router.route('/reference/railway_station')
    // Створюэмо новий елемент в таблиці
    .post(async (req, res) => {
        //References.ServiceTypeController.create_service_type(req, res);
    })

router.route('/reference/railway_station/:id')
...
router.route('/reference/count/railway_station')
