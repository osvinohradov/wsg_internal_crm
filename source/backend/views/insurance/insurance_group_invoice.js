 ...
 * Method: GET
 * 
 * Route: /insurance/group/invoices
 * 
 * Description:
 ...
 * 
 */
export async function get_all_insurance_group_invoices(req, res){
 ...
 */
export async function create_insurance_group_invoice(req, res) {
    let err = null;
    let body = req.body;
 ...
 * Method: PUT
 * 
 * Route: /insurance/group/invoice/:id
 * 
 * Description:
 ...
 * @param {HttpResponse} res 
 */
export async function update_insurance_group_invoice(req, res) {
 ...
 * @param {HttpResponse} res 
 */
export async function remove_insurance_group_invoice(req, res) {
    let airport_id = req.params.id;
    try {
 ...
 * @param {HttpResponse} res 
 */
export async function get_insurance_group_invoice_by_id(req, res) {
    let airport_id = req.params.id;
    let airport = null;
 ...
 * Method: GET
 * 
 * Route: /insurance/group/count/invoice
 * 
 * Description:
 ...
 * @param {HttpResponse} res 
 */
export async function get_insurance_group_invoice_count(req, res) {
