 ...
 * 
 */
export async function get_all_train_group_invoices(req, res){
 ...
 */
export async function create_train_group_invoice(req, res) {
    let err = null;
    let body = req.body;
 ...
 * @param {HttpResponse} res 
 */
export async function update_train_group_invoice(req, res) {
 ...
 * @param {HttpResponse} res 
 */
export async function remove_train_group_invoice(req, res) {
    let airport_id = req.params.id;
    try {
 ...
 * @param {HttpResponse} res 
 */
export async function get_train_group_invoice_by_id(req, res) {
    let airport_id = req.params.id;
    let airport = null;
 ...
 * Method: GET
 * 
 * Route: /train/group/count/invoice
 * 
 * Description:
 ...
 * @param {HttpResponse} res 
 */
export async function get_train_group_invoice_count(req, res) {
