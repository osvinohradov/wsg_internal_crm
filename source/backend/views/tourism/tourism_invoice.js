 ...
 * 
 */
export async function get_all_tourism_invoices(req, res){
 ...
 */
export async function create_tourism_invoice(req, res) {
    let err = null;
    let body = req.body;
 ...
 * @param {HttpResponse} res 
 */
export async function update_tourism_invoice(req, res) {
 ...
 * @param {HttpResponse} res 
 */
export async function remove_tourism_invoice(req, res) {
    let airport_id = req.params.id;
    try {
 ...
 * @param {HttpResponse} res 
 */
export async function get_tourism_invoice_by_id(req, res) {
    let airport_id = req.params.id;
    let airport = null;
 ...
 * @param {HttpResponse} res 
 */
export async function get_tourism_invoice_count(req, res) {
