 ...
 * 
 */
export async function get_all_tourism_group_invoices(req, res){
 ...
 */
export async function create_tourism_group_invoice(req, res) {
    let err = null;
    let body = req.body;
 ...
 * Method: PUT
 * 
 * Route: /tourism/group/invoice/:id
 * 
 * Description:
 ...
 * @param {HttpResponse} res 
 */
export async function update_tourism_group_invoice(req, res) {
 ...
 * @param {HttpResponse} res 
 */
export async function remove_tourism_group_invoice(req, res) {
    let airport_id = req.params.id;
    try {
 ...
 * @param {HttpResponse} res 
 */
export async function get_tourism_group_invoice_by_id(req, res) {
    let airport_id = req.params.id;
    let airport = null;
 ...
 * Method: GET
 * 
 * Route: /tourism/group/count/invoice
 * 
 * Description:
 ...
 * @param {HttpResponse} res 
 */
export async function get_tourism_group_invoice_count(req, res) {
