...
export class CounterpartyReferencesComponent implements OnInit {
  ...
  // constructor(public dialog: MatDialog, private RefCounterpartyService: RefCounterpartyService) {}
  ...
  //   this.RefCounterpartyService.get_counterparties_count().subscribe(data => {
  ...
  //   this.RefCounterpartyService.get_counterparties(skip, limit).subscribe(data => {
  ...
  //   this.RefCounterpartyService.get_counterparties(this.skip, this.limit).subscribe(data => {
  //     this.counterparties = data;
