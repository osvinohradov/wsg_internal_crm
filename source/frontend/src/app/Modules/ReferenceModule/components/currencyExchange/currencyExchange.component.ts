...
constructor(public dialog: MatDialog, private RefCurrencyExchangeService: RefCurrencyExchangeService) { }
...
get_currency_exchanges_count(){
  this.RefCurrencyExchangeService.get_currency_exchange_count().subscribe((data) => {
